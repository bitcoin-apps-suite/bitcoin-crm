...
import { Users, DollarSign, TrendingUp, Coins, Award, Target } from 'lucide-react'

export default function TokenPage() {
  const tokenStats = {
    name: "Bitcoin CRM Token",
    symbol: "$bCRM",
  ...
  const tokenAllocation = [
    { category: "Development Contracts", percentage: 10, amount: "100,000,000", color: "bg-blue-500" },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            The native utility token for Bitcoin CRM, enabling decentralized customer relationship management on bitcoin sv 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
            ...
            <div className="text-xs text-blue-400">Fixed Supply</div>
          </div>
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
