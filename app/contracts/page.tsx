...
import { Users, FileText, Clock, CheckCircle, AlertCircle, Coins } from 'lucide-react'
    ...
    available: [
      {
        ...
        description: 'Build responsive React components for crm interface',
        reward: '5,000,000',
        difficulty: 'Medium',
        deadline: '2 weeks',
      ...
      },
      {
        ...
        description: 'Build sCrypt smart contracts for automated crm workflows',
        reward: '10,000,000',
        difficulty: 'Expert',
        deadline: '4 weeks',
    ...
    inProgress: [
      {
        ...
        description: 'Design and implement PostgreSQL schema for crm data',
        reward: '3,000,000',
        difficulty: 'Easy',
        progress: 60,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-6">
            ...
            <div>
              ...
              <p className="text-xl text-gray-300">Earn $bCRM tokens by contributing to Bitcoin CRM</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
            ...
            <div className="text-2xl font-bold text-white">0 $bCRM</div>
            <div className="text-xs text-blue-400">Max: 100M (10%)</div>
          </div>
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
