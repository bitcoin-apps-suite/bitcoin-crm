      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-8">
            <div className="bg-blue-500 p-6 rounded-full mr-6">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
            Decentralized Customer Relationship Management on Bitcoin SV
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/token" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold flex items-center transition-colors">
              View $bCRM Token <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
            <Link href="/contracts" className="bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-lg font-semibold flex items-center transition-colors">
              Development Contracts <DollarSign className="ml-2 w-5 h-5" />
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
            <div className="bg-blue-500 p-4 rounded-full w-fit mb-6">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
            ...
            <p className="text-gray-300">Earn $bCRM tokens by contributing to development and using the platform.</p>
          </div>
        </div>

        {/* Quick Links */}
        <div className="text-center">
          <h2 className="text-3xl font-bold text-white mb-8">Explore Bitcoin CRM</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Link href="/token" className="bg-white/5 hover:bg-white/10 text-white p-6 rounded-lg transition-colors">
              <div className="text-2xl mb-2">💰</div>
              <div className="font-semibold">$bCRM Token</div>
            </Link>
