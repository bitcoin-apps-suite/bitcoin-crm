...
import { Users, CheckSquare, Clock, User, Github, Coins } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">Bitcoin CRM Tasks</h1>
              <p className="text-xl text-gray-300">Open source development tasks with $bCRM rewards</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
            ...
            <div className="text-lg font-bold text-blue-400">{(taskStats.totalReward / 1000000).toFixed(1)}M $bCRM</div>
          </div>
        </div>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center mb-2">
                    <span className="text-blue-400 font-mono text-sm mr-3">{task.id}</span>
                ...
                <div className="text-right ml-6">
                  ...
                  <div className="text-sm text-blue-400">$bCRM</div>
                </div>
              </div>
        ...
        <div className="mt-12 bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">Choose from available GitHub issues with $bCRM rewards</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-500 p-4 rounded-full w-fit mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">Receive $bCRM tokens after PR is merged</p>
            </div>
          </div>
        </div>
      </div>
