...
import { Users, ArrowUpDown, TrendingUp, DollarSign, Activity } from 'lucide-react'

export default function ExchangePage() {
  const [fromAmount, setFromAmount] = useState('')
  const [toAmount, setToAmount] = useState('')
  const [fromCurrency, setFromCurrency] = useState('BSV')
  const [toCurrency, setToCurrency] = useState('bCRM')

  const exchangeRates = {
    'BSV': { 'bCRM': 10000, 'USD': 50 },
    'bCRM': { 'BSV': 0.0001, 'USD': 0.005 },
    'USD': { 'BSV': 0.02, 'bCRM': 200 }
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-6">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">Bitcoin CRM Exchange</h1>
              <p className="text-xl text-gray-300">Trade BSV, $bCRM, and other cryptocurrencies</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 mb-8">
            ...
            <div>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                ...
                >
                  ...
                  <option value="bCRM">bCRM - Bitcoin CRM Token</option>
          ...
          <div className="flex justify-center mt-6">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-12 py-4 rounded-lg font-semibold flex items-center transition-colors"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">bCRM Price</h3>
            </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
          ...
          <div className="space-y-4">
            {[
              { from: 'BSV', to: 'bCRM', amount: '0.1', value: '1,000', time: '2 min ago' },
              { from: 'bCRM', to: 'USD', amount: '5,000', value: '25', time: '5 min ago' },
              { from: 'USD', to: 'BSV', amount: '100', value: '2', time: '8 min ago' },
            ].map((tx, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                <div className="flex items-center">
                  <ArrowUpDown className="w-5 h-5 text-blue-500 mr-3" />
                  <div>
